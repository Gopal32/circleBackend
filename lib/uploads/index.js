...
const filterImageVideo = function (req, file, cb) {
  ...
  if (extname) {
    return cb(null, true)
      ...
      const err = { ...__constants.RESPONSE_MESSAGES.INVALID_FILE_TYPE, err: 'File upload only supports the following filetypes - jpg, jpeg, png, mp4' }
      cb(err)
  }
}
...
const uploadNews = multer({
  ...
  module.exports = {uploadImage, uploadCategory, uploadNews};